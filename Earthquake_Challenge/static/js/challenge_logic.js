...
// It took me way to long to realize that I needed to use the raw data and not just the github.com site for this to work.. >:()
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then((data) => {
  console.log(data);
  L.geoJson(data,{
    style: {color: "#FFC300", weight: 6}})
     .addTo(tectonicPlates);
  });

  // Adds tectonic plates to the map:
